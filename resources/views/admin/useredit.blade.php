...
@endsection
@section('header')
    <h1 class="admissionstatus">All User</h1>
@endsection
@section('content')
    <style>
        .h11 {
                ...
                <tbody id="table-body">
                    ...
                    @foreach ($user_info as $info)
                        <tr class="no-border-bottom">
                            ...
                            <td id="filecheck">
                                <button type="button" class="documentbt change-btn3" data-bs-toggle="modal"
                                    data-bs-target="#User_Profile{{ $info->id }}">
                                    View Profile
                                </button>
                            </td>
                            <td>
                                @if ($info->interview_result == 1)
                                    &nbsp;&nbsp;&nbsp;<i class="fas fa-check-circle"
                                        style="color: greenyellow;"></i>&nbsp;<a style="color: greenyellow;">Completed</a>
                                @elseif(
                                    $info->cv_status == 1 &&
                                        $info->motivation_status == 1 &&
                                        $info->passport_status == 1 &&
                                        $info->transcript_status == 1)
                                    &nbsp;&nbsp;&nbsp;<i class="fas fa-spinner fa-spin-pulse"
                                        style="color: orange;"></i>&nbsp;<a style="color: orange;">Waiting for interview</a>
                                @else
                                    &nbsp;&nbsp;&nbsp;<i class="fas fa-spinner fa-spin-pulse"
                                        style="color: orange;"></i>&nbsp;<a style="color: orange;">Haven't checked</a>
                                @endif
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                <div class="modal-body">
                                    <div class="modal-content" style="padding: 20px;"><br>
                                        ...
                                        <div class="flex mb-4 w-full pr-2">
                                            ...
                                            <div class="mb-4 w-4 pr-2">
                                                <label for="university"
                                                    class="block font-medium mb-2 it">University</label>
                                                <input type="text" id="university" name="university"
                                                    class="border rounded px-4 py-2 w-full"
                                                    value="{{ $info->university }}" readonly>
                                            </div>
                                            <div class="mb-4 w-4 pr-2">
                                        ...
                                        <div class="flex mb-4 w-full pr-2">
                                            <div class="mb-4 w-2 pr-2">
                                                <label for="internship_duration"
                                                    class="block font-medium mb-2 it">Internship
                                                    Duration</label>
                                            ...
                                            <div class="mb-4 w-2 pr-2">
                                                ...
                                                <input type="date" id="starting_date" name="starting_date"
                                                    class="border rounded px-4 py-2 w-full"
                                                    value="{{ $info->start_date }}" readonly
    ...
    @else
        <div class="alert alert-warning" role="alert" style="text-align: center; width: 50%; margin: 0 auto;"><i
                class="fa-solid fa-triangle-exclamation"></i> ไม่มี User ที่สมัครเข้ามา
        </div>
    @endif
@endsection
